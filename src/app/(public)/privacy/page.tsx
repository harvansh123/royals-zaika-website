...
export const metadata: Metadata = {
  title: "Privacy Policy — Chaurasia Ji",
  description:
    "Read Chaurasia Ji's Privacy Policy to understand how we collect, use, and protect your personal information when you use our food ordering platform.",
};
        ...
        <div className="lg:flex lg:gap-12">
          ...
          <main className="flex-1 space-y-12 text-sm leading-relaxed" style={{ color: "var(--text-secondary, #94a3b8)" }}>
            ...
            <section id="introduction">
              ...
              <p className="mb-3">
                Welcome to <strong className="text-white">Chaurasia Ji</strong> (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or
              ...
              <p className="mb-3">
                This Privacy Policy explains how Chaurasia Ji collects, uses, discloses, and
            ...
            <section id="account-deletion">
              ...
              <p className="mb-3">
                You have the right to request deletion of your Chaurasia Ji account. Upon deletion:
              </p>
              <InfoList items={[
            ...
            <section id="contact">
              ...
              >
                <p><span className="text-orange-400 font-semibold">Restaurant:</span> <span className="text-white">Chaurasia Ji</span></p>
