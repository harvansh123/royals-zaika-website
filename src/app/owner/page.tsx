...
export default function OwnerDashboard() {
  ...
  // Alarm ref ΓÇö stop function returned by startLoopingAlarm()
  ...
  // ΓöÇΓöÇ Toggle Restaurant Open/Closed ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  async function loadDashboard() {
    ...
    const [{ data: todayOrders }, ordersRes, { data: outOfStock }] = await Promise.all([
      ...
      // FIX 1: Use server-side API so service role bypasses RLS ΓåÆ order_items always visible
  ...
  async function updateStatus(orderId: string, status: string) {
    ...
    // ΓöÇΓöÇ "delivered": use dedicated API that updates BOTH orders + delivery_tracking ΓöÇΓöÇ
            ...
            {orders.slice(0, 8).map((order) => {
              ...
              return (
                <div key={order.id}>
                  ...
                  {/* ΓöÇΓöÇ FIX 1: Expanded Order Details with Items ΓöÇΓöÇ */}
                  {isExp && (
