...
export async function POST(req: Request) {
  try {
    ...
    await transporter.sendMail({
      from: `"Chaurasia Ji Support" <${gmailUser}>`,
      to: OWNER_EMAIL,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #111; color: #e5e5e5; border-radius: 12px; overflow: hidden; border: 1px solid #333;">
          <div style="background: linear-gradient(135deg, #f97316, #dc2626); padding: 24px 32px;">
            <h1 style="margin: 0; color: white; font-size: 22px;">🍽️ Chaurasia Ji — New Support Ticket</h1>
          </div>
          <div style="padding: 28px 32px;">
            ...
            <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid #2a2a2a; text-align: center;">
              <p style="color: #6b7280; font-size: 12px; margin: 0;">Chaurasia Ji Restaurant — Automated Support Notification</p>
            </div>
          </div>
        </div>
      `,
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #111; color: #e5e5e5; border-radius: 12px; overflow: hidden; border: 1px solid #333;">
          <div style="background: linear-gradient(135deg, #f97316, #dc2626); padding: 24px 32px;">
            <h1 style="margin: 0; color: white; font-size: 22px;">🍽️ Chaurasia Ji</h1>
          </div>
          <div style="padding: 28px 32px;">
            ...
            <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #2a2a2a; text-align: center;">
              <p style="color: #6b7280; font-size: 12px; margin: 0;">Chaurasia Ji Restaurant — We're here to help! 🍽️</p>
            </div>
          </div>
        </div>
      `,
